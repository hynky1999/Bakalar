...
% Declare unsuported unicode mapping
\DeclareUnicodeCharacter{301C}{\textasciitilde}
...
\usepackage[backend=bibtex,style=numeric, url=false, doi=false, isbn=false, natbib=true,sorting=none]{biblatex}
...
%\include{attachments}
\include{gradio_app}
\include{baseline_features}
\include{confs_and_repots}
